...
import 'package:flutter_windowmanager/flutter_windowmanager.dart' if (dart.library.html) 'package:vaultx_app/utils/flutter_windowmanager_web.dart';
...
class UIOverlayHelper {
  ...
  static Future<void> enableSecureMode() async {
    ...
    if (Platform.isIOS) {
      ...
      await SystemChannels.platform.invokeMethod<void>('SystemChrome.setPreventScreenCapture', true);
    }
  ...
  static Future<void> disableSecureMode() async {
    if (Platform.isIOS) {
      await SystemChannels.platform.invokeMethod<void>('SystemChrome.setPreventScreenCapture', false);
    } else if (Platform.isAndroid) {
      await FlutterWindowManager.clearFlags(FlutterWindowManager.FLAG_SECURE);
    }
  }
  
  static void refreshStatusBarIconsForTheme(ThemeMode mode, Brightness platformBrightness) {
